...
class ShellTool {
    ...
    async run(command) {
        ...
        return this.core.execute(async () => {
            // Security: Enforce strict execution boundaries to prevent Denial of Service (DoS).
            // Prevent commands from hanging indefinitely or exhausting memory via excessive output.
